...
export const Contact: React.FC = () => {
  ...
  return (
    <div className="bg-[#070b14]">
      {/* 1. Hero */}
      <section className="relative pt-8 sm:pt-12 pb-14 sm:pb-16 bg-gradient-to-b from-[#0a1122] via-[#070b14] to-[#070b14] border-b border-slate-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/10 text-amber-400 border border-amber-500/20 text-xs font-semibold uppercase tracking-wider mb-4"
          >
          ...
          <motion.p
            ...
            className="mt-3 sm:mt-4 text-xs sm:text-base text-slate-300 max-w-2xl mx-auto leading-relaxed"
          >
      ...
      <section className="py-12 sm:py-20 bg-[#070b14]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-5 space-y-4 sm:space-y-6">
              ...
              <a
                ...
                className="flex items-start gap-3.5 sm:gap-4 p-4 sm:p-5 rounded-2xl bg-[#0f172a] border border-slate-800 hover:border-amber-500/50 transition-all group block card-hover-glow"
              >
                <div className="p-2.5 sm:p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-400 group-hover:bg-amber-500 group-hover:text-slate-950 transition-colors shrink-0">
                  <Phone className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-xs font-semibold text-slate-400">Direct Hotline / WhatsApp</p>
                  <p className="text-sm sm:text-base font-bold text-white group-hover:text-amber-400 transition-colors mt-0.5">
                    {firmData.phone}
                  </p>
                  <p className="text-[11px] text-emerald-400 mt-1">Available Mon–Sat: 9:30 AM – 6:30 PM</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <p className="text-xs font-semibold text-slate-400">Direct Inquiries & Briefs</p>
                  <p className="text-sm sm:text-base font-bold text-white group-hover:text-amber-400 transition-colors mt-0.5 break-all">
                    {firmData.email}
                  </p>
                  <p className="text-[11px] text-slate-400 mt-1">2-Hour First Response Time</p>
                </div>
              </a>

              {/* Office Address */}
              <div className="flex items-start gap-3.5 sm:gap-4 p-4 sm:p-5 rounded-2xl bg-[#0f172a] border border-slate-800">
                <div className="p-2.5 sm:p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-400 shrink-0">
                  <MapPin className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-xs font-semibold text-slate-400">Corporate Office Address</p>
                  <p className="text-xs sm:text-sm font-medium text-white mt-0.5 leading-relaxed">
                    {firmData.address}
                  </p>
                  <p className="text-[11px] text-amber-400/90 font-medium mt-1.5 flex items-center gap-1">
              ...
              <div className="p-4 sm:p-5 rounded-2xl bg-[#0a1020] border border-amber-500/20 space-y-1.5">
            ...
            <div className="lg:col-span-7">
              <div className="rounded-2xl sm:rounded-3xl bg-[#0e1629] border border-amber-500/30 p-5 sm:p-8 md:p-10 shadow-2xl shadow-black/80 card-hover-glow">
                ...
                {isSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-xs sm:text-sm text-slate-300 max-w-md mx-auto mb-6 leading-relaxed">
                      Thank you, <span className="text-amber-400 font-semibold">{formData.name}</span>. A designated senior partner has been assigned to your request and will contact you shortly.
                    </p>
                    <Button
                      variant="primary"
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-3.5 py-2.5 rounded-xl bg-slate-900/90 border border-slate-700/80 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition-colors"
                          />
                        </div>
                        <div>
                          <label className="block text-xs font-medium text-slate-300 mb-1">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
                        <div>
                          ...
                          <select
                            ...
                            className="w-full px-3.5 py-2.5 rounded-xl bg-slate-900/90 border border-slate-700/80 text-sm text-white focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition-colors"
                          >
                            {servicesData.map((s) => (
                            ...
                            <option value="all-in-one" className="bg-slate-900 text-white">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full px-3.5 py-2.5 rounded-xl bg-slate-900/90 border border-slate-700/80 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition-colors resize-none"
                        />
                      </div>
      ...
      <section className="py-14 sm:py-20 bg-[#080d19] border-t border-slate-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-3.5 sm:space-y-4">
            {contactFaqs.map((faq, idx) => (
              <div key={idx} className="p-5 sm:p-6 rounded-2xl bg-[#0f172a] border border-slate-800 space-y-2 card-hover-glow">
