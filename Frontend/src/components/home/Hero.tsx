      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <a
              href="/calculator"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 text-amber-900 border border-amber-500/20 font-bold transition-all"
            >
              <Calculator className="w-4 h-4 text-amber-600" />
              <span>Free Tax Calculator (Old vs New Regime)</span>
            </a>
            <a
              href="/track"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 border border-slate-200 font-bold transition-all"
            >
