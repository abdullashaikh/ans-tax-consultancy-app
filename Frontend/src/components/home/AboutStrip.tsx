...
export const AboutStrip: React.FC = () => {
  return (
    <section className="py-16 sm:py-20 bg-slate-50 border-y border-slate-200 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-amber-50 text-amber-800 border border-amber-200 shadow-sm">
          ...
          >
            <div className="relative rounded-2xl p-6 sm:p-8 bg-white border border-slate-200 shadow-xl overflow-hidden card-hover-glow">
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-slate-900 font-bold text-base">Client Commitment</h4>
                      <p className="text-xs text-slate-500 font-medium">Excellence in Every Audit</p>
                    </div>
                  </div>
                ...
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2 text-xs text-slate-600">
                  <p className="font-bold text-amber-800 flex items-center gap-1.5">
                    <Target className="w-3.5 h-3.5 text-amber-600" /> Our Guarantee
                  </p>
                ...
                <div className="pt-2 grid grid-cols-2 gap-4 border-t border-slate-200 text-center">
                  <div>
                    <p className="text-2xl font-extrabold text-slate-900">350+</p>
                    <p className="text-xs text-slate-500 font-medium mt-0.5">Retained Clients</p>
                  </div>
                  <div>
                    <p className="text-2xl font-extrabold text-amber-600">99.8%</p>
                    <p className="text-xs text-slate-500 font-medium mt-0.5">Filing Accuracy</p>
                  </div>
                </div>
              </div>
            </div>
